...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header"><br>
      <h1>Seminar<small>Data Seminar</small></h1>
              ...
              <table id="mahasiswa" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url('seminar/detail/'.$row['nim']) ?>" class="btn btn-sm btn-info btn-flat"><i class="fa fa-book"></i> Detail</a>
                      <a href="<?php echo base_url('seminar/edit/'.$row['nim']) ?>" class="btn btn-sm btn-primary btn-flat"><i class="fa fa-edit"></i> Update</a>
                      <a onclick="deleteConfirm('<?php echo site_url('seminar/delete/'.$row['nim']) ?>')" class="btn btn-sm btn-danger btn-flat"><i class="fa fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
                  <!-- /Seminar Untuk Administrator -->
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url('seminar/detail/'.$row['nim']) ?>" class="btn btn-sm btn-info btn-flat"><i class="fa fa-book"></i> Detail</a>
                      <a href="<?php echo base_url('seminar/edit/'.$row['nim']) ?>" class="btn btn-sm btn-primary btn-flat"><i class="fa fa-edit"></i> Edit</a>
                      <a onclick="deleteConfirm('<?php echo site_url('seminar/delete/'.$row['nim']) ?>')" class="btn btn-sm btn-danger btn-flat"><i class="fa fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
                <?php }} ?>
